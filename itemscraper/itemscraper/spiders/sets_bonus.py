...
import scrapy
from itemscraper.items import MissingNo, ItemscraperSetData

UNDER_100_IDS = range(1, 601)



BASE_URL = 'https://www.dofus.com/en/mmorpg/encyclopedia/sets/%d-catseye-set'
STAT_TRANSLATE = {
    '% Power': 'Power',
    'Damage': 'Damage',
    'Heals': 'Heals',
